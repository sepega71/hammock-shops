 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".inner-right-bell__slider")) new swiper_core_Swiper(".inner-right-bell__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".top-productcards__slider")) new swiper_core_Swiper(".top-productcards__slider", {
            ...
            if (document.querySelector(".bottom-productcards__slider")) new swiper_core_Swiper(".bottom-productcards__slider", {
                modules: [ Pagination, Thumb ],
                observer: true,
                observeParents: true,
                mousewheel: true,
                ...
                spaceBetween: 0,
                thumbs: {
                    swiper: ".top-productcards__slider"
                },
                pagination: {
            ...
            if (document.querySelector(".other__slider")) new swiper_core_Swiper(".other__slider", {
                observer: true,
                observeParents: true,
                spaceBetween: 0,
                autoHeight: true,
            ...
            if (document.querySelector(".catalogs__slider")) new swiper_core_Swiper(".catalogs__slider", {
                observer: true,
                observeParents: true,
                spaceBetween: 0,
                autoHeight: true,
